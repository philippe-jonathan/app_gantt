...
var date;
var time;
//au click du boutton on envoie les valeurs des inputs dans la base de données et on les affiche.
...
$('#submit_btn').click(function(){
    ...
    // localStorage.setItem("taskname", "John");
    // alert( "taskname = " + localStorage.getItem("taskname"));
    db.transaction(selectAll);

    // localStorage.setItem("name", name);
    // $('.result').html("<label> the name is = </label> " + localStorage.getItem("name"));
});
